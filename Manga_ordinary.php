...
<body>
    ...
    <script>
        ...
        function addToCart(productId) {
            ...
            fetch(`Manga_ordinary.php?get_product=${productId}`)
        ...
        function updateStock(productId, newStock) {
            fetch(`Manga_ordinary.php?update_stock=${productId}&new_stock=${newStock}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function updateCartModal() {
            ...
            cart.forEach(product => {
                fetch(`Manga_ordinary.php?get_product=${product.id}`)
                    .then(response => response.json())
                    .then(latestProduct => {
