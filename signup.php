...
?>
   ...
   <div align="center" style="margin-top:50px;" class="container">
    <div style="width:600px; height: 480px; border: solid 1px #333333; " align="left" class="login-box">
     <div class="login-header"><b>Sign up</b></div>
     <div style="margin:30px">
	 
      <form action="check_signup.php" method="post">
	  <label>FullName  :</label><input type="text" name="username" placeholder= "Fullname" required class="box"/><br /><br />
        <label>Type UserName  :</label><input type="text" name="username" placeholder= "Username"  class="box"/><br /><br />
        <label>Type Password  :</label><input type="password" name="password" placeholder= "Password" class="box" /><br/><br />
